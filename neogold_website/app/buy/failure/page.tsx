      ...
      <div className="container mx-auto px-4">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            We're sorry, but your gold purchase could not be completed at this time.
          </p>
            ...
            <div className="p-6">
              ...
              <ul className="text-left space-y-3 mb-6">
                ...
                <li className="flex items-start">
                  ...
                  <span>Temporary issue with our payment system</span>
                </li>
              </ul>
              
              <h3 className="text-base font-medium text-gray-800 mb-2">What can you do?</h3>
              <p className="text-gray-600 mb-4">
                Please verify your payment details and try again. If the issue persists, contact your bank or try a different payment method.
              </p>
              ...
              <div className="flex items-start">
                ...
                <p className="text-sm text-gray-500">
                  If you believe your account was charged but the transaction failed, please contact our support team at support@neogold.com or call us at +91 1234567890.
                </p>
              </div>
            </div>
          </div>
